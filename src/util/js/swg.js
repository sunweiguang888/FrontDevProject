...
// 上面Sizzle代码在webpack中不会添加window.Sizzle
Sizzle = window.Sizzle || require('sizzle');
...
(function(){
	...
	// CommonJS规范
	typeof module !== 'undefined' && typeof module.exports !== 'undefined' ? module.exports = swg : null;
})();
